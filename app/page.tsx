      ...
      <header>
        <nav className="wrap">
          ...
          <div className="nav-links">
            ...
            <a href="#voluntariar">Voluntariar</a>
          </div>
          ...
          <div className="foot-grid">
            <div>
              ...
              <p style={{ fontSize: "0.86rem", maxWidth: "32ch", opacity: 0.7 }}>
                Movimento para Proteção Integral de Crianças e Adolescentes Vulneráveis. ONG registada
                e certificada em Angola, a proteger o futuro de quem mais precisa.
              </p>
            </div>
            <div>
              <h4>Navegação</h4>
            ...
            <div>
              <h4>Contacto</h4>
              <a href="#">ong@mopica.org</a>
              <a href="#">www.mopica.org</a>
              <a href="#">+244 935 518 305 · +244 924 250 525</a>
              <a href="#">Luanda, Município dos Mulenvos</a>
              <a href="#">Instagram · Facebook</a>
            </div>
          </div>
          <div className="foot-bottom">
            <span>© 2026 MOPICA. Todos os direitos reservados. · NIF 5002179938 · Registo n.º 38/2025 · Certidão n.º 107-A</span>
            <div className="lang-switch"><b>PT</b><span>/</span>EN</div>
          </div>
          <div className="foot-address">
            Sede Nacional: Bairro Baixa de Cassange, Vila Nova da Boa-fé, Casa Nº 86, Q.1, Zona 5,
